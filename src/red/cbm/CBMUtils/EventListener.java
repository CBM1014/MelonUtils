    ...
    */
    ...
    public void onEntityDamage(EntityDamageEvent event) {
        switch (event.getEntityType()) {
            ...
            case VILLAGER:
                if (event.getEntity() instanceof LivingEntity) {
                    if (((LivingEntity) event.getEntity()).isSwimming()) {
                        spawnParticle(Particle.BLOCK_DUST, event.getEntity(), 120, 0D, 0D, 0D, Material.RED_CONCRETE);

                    } else {
                        spawnParticle(Particle.BLOCK_DUST, event.getEntity(), 100, 0D, 1D, 0D, Material.RED_CONCRETE);
                        spawnParticle(Particle.BLOCK_DUST, event.getEntity(), 80, 0D, 1.2D, 0D, Material.RED_CONCRETE);
                    }
                }
                break;
            ...
            case MULE:
            case TURTLE:
                spawnParticle(Particle.BLOCK_DUST, event.getEntity(), 100, 0D, 0.5D, 0D, Material.REDSTONE_BLOCK);
                break;
            case ZOMBIE:
            ...
            case ENDERMAN:
                ...
                spawnParticle(Particle.BLOCK_DUST, event.getEntity(), 30, 0D, 1D, 0D, Material.REDSTONE_BLOCK);
                spawnParticle(Particle.BLOCK_DUST, event.getEntity(), 30, 0D, 1.5D, 0D, Material.REDSTONE_BLOCK);
                break;
            case HUSK:
            ...
            case VEX:
                ...
                break;
            case ENDER_DRAGON:
                spawnParticle(Particle.BLOCK_DUST, event.getEntity(), 50, 0D, 1D, 0D, Material.BLACK_CONCRETE);
                spawnParticle(Particle.BLOCK_DUST, event.getEntity(), 50, 0D, 1D, 0D, Material.REDSTONE_BLOCK);
        }
